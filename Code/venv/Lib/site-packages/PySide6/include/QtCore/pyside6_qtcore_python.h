...
enum [[deprecated]] : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 904,
    ...
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 314,
    SBK_QFUTUREINTERFACEBASE_CANCELMODE_IDX                  = 312,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 310,
    SBK_QGENERICARGUMENT_IDX                                 = 316,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 318,
    SBK_QHASHSEED_IDX                                        = 320,
    SBK_QIODEVICE_IDX                                        = 322,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 326,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 228,
    SBK_QIODEVICEBASE_IDX                                    = 324,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 328,
    SBK_QITEMSELECTION_IDX                                   = 330,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 334,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 230,
    SBK_QITEMSELECTIONMODEL_IDX                              = 332,
    SBK_QITEMSELECTIONRANGE_IDX                              = 336,
    SBK_QJSONARRAY_IDX                                       = 338,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 342,
    SBK_QJSONDOCUMENT_IDX                                    = 340,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 346,
    SBK_QJSONPARSEERROR_IDX                                  = 344,
    SBK_QJSONVALUE_TYPE_IDX                                  = 350,
    SBK_QJSONVALUE_IDX                                       = 348,
    SBK_QKEYCOMBINATION_IDX                                  = 352,
    SBK_QLIBRARY_LOADHINT_IDX                                = 356,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 232,
    SBK_QLIBRARY_IDX                                         = 354,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 360,
    SBK_QLIBRARYINFO_IDX                                     = 358,
    SBK_QLINE_IDX                                            = 362,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 366,
    SBK_QLINEF_IDX                                           = 364,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 378,
    SBK_QLOCALE_SCRIPT_IDX                                   = 910,
    SBK_QLOCALE_COUNTRY_IDX                                  = 370,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 382,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 376,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 384,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 238,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 374,
    SBK_QLOCALE_TAGSEPARATOR_IDX                             = 386,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 906,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 372,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 234,
    SBK_QLOCALE_LANGUAGECODETYPE_IDX                         = 380,
    SBK_QFLAGS_QLOCALE_LANGUAGECODETYPE_IDX                  = 236,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 908,
    SBK_QLOCALE_IDX                                          = 368,
    SBK_QLOCATIONPERMISSION_ACCURACY_IDX                     = 390,
    SBK_QLOCATIONPERMISSION_AVAILABILITY_IDX                 = 392,
    SBK_QLOCATIONPERMISSION_IDX                              = 388,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 396,
    SBK_QLOCKFILE_IDX                                        = 394,
    SBK_QLOGGINGCATEGORY_IDX                                 = 398,
    SBK_QMARGINS_IDX                                         = 400,
    SBK_QMARGINSF_IDX                                        = 402,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 404,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 406,
    SBK_QMETACLASSINFO_IDX                                   = 408,
    SBK_QMETAENUM_IDX                                        = 410,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 414,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 416,
    SBK_QMETAMETHOD_IDX                                      = 412,
    SBK_QMETAOBJECT_CALL_IDX                                 = 420,
    SBK_QMETAOBJECT_IDX                                      = 418,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 422,
    SBK_QMETAPROPERTY_IDX                                    = 424,
    SBK_QMETATYPE_TYPE_IDX                                   = 428,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 430,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 240,
    SBK_QMETATYPE_IDX                                        = 426,
    SBK_QMICROPHONEPERMISSION_IDX                            = 432,
    SBK_QMIMEDATA_IDX                                        = 434,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 438,
    SBK_QMIMEDATABASE_IDX                                    = 436,
    SBK_QMIMETYPE_IDX                                        = 440,
    SBK_QMODELINDEX_IDX                                      = 442,
    SBK_QMODELROLEDATA_IDX                                   = 444,
    SBK_QMUTEX_IDX                                           = 446,
    SBK_QNATIVEIPCKEY_TYPE_IDX                               = 450,
    SBK_QNATIVEIPCKEY_IDX                                    = 448,
    SBK_QOBJECT_IDX                                          = 452,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 454,
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 458,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 456,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 460,
    SBK_QPAUSEANIMATION_IDX                                  = 462,
    SBK_QPERMISSION_IDX                                      = 464,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 466,
    SBK_QPLUGINLOADER_IDX                                    = 468,
    SBK_QPOINT_IDX                                           = 470,
    SBK_QPOINTF_IDX                                          = 472,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 484,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 486,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 480,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 482,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 478,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 476,
    SBK_QPROCESS_IDX                                         = 474,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 490,
    SBK_QPROCESSENVIRONMENT_IDX                              = 488,
    SBK_QPROPERTYANIMATION_IDX                               = 492,
    SBK_QRANDOMGENERATOR_IDX                                 = 494,
    SBK_QRANDOMGENERATOR64_IDX                               = 496,
    SBK_QREADLOCKER_IDX                                      = 498,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 502,
    SBK_QREADWRITELOCK_IDX                                   = 500,
    SBK_QRECT_IDX                                            = 504,
    SBK_QRECTF_IDX                                           = 506,
    SBK_QRECURSIVEMUTEX_IDX                                  = 508,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 516,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 244,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 514,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 512,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 242,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 518,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 246,
    SBK_QREGULAREXPRESSION_IDX                               = 510,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 520,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 522,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 526,
    SBK_QRESOURCE_IDX                                        = 524,
    SBK_QRUNNABLE_IDX                                        = 528,
    SBK_QSAVEFILE_IDX                                        = 530,
    SBK_QSEMAPHORE_IDX                                       = 532,
    SBK_QSEMAPHORERELEASER_IDX                               = 534,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 536,
    SBK_QSETTINGS_STATUS_IDX                                 = 544,
    SBK_QSETTINGS_FORMAT_IDX                                 = 540,
    SBK_QSETTINGS_SCOPE_IDX                                  = 542,
    SBK_QSETTINGS_IDX                                        = 538,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 548,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 550,
    SBK_QSHAREDMEMORY_IDX                                    = 546,
    ...
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 248,
    ...
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 250,
    ...
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 252,
    ...
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 254,
    ...
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 258,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 668,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 262,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 660,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 256,
    SBK_QURL_IDX                                             = 658,
    ...
    SBK_QWINEVENTNOTIFIER_IDX                                = 686,
    SBK_QWRITELOCKER_IDX                                     = 688,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 690,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 692,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 694,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 696,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 698,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 700,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 708,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 706,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 704,
    SBK_QXMLSTREAMREADER_IDX                                 = 702,
    SBK_QXMLSTREAMWRITER_IDX                                 = 710,
    SBK_QT_GLOBALCOLOR_IDX                                   = 782,
    SBK_QT_COLORSCHEME_IDX                                   = 740,
    SBK_QT_MOUSEBUTTON_IDX                                   = 814,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 290,
    SBK_QT_ORIENTATION_IDX                                   = 824,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 294,
    SBK_QT_FOCUSPOLICY_IDX                                   = 772,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 852,
    SBK_QT_SORTORDER_IDX                                     = 848,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 850,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 298,
    SBK_QT_TILERULE_IDX                                      = 862,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 714,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 264,
    SBK_QT_TEXTFLAG_IDX                                      = 856,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 854,
    SBK_QT_WHITESPACEMODE_IDX                                = 880,
    SBK_QT_HITTESTACCURACY_IDX                               = 786,
    SBK_QT_WINDOWTYPE_IDX                                    = 890,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 308,
    SBK_QT_WINDOWSTATE_IDX                                   = 888,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 306,
    SBK_QT_APPLICATIONSTATE_IDX                              = 720,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 266,
    SBK_QT_SCREENORIENTATION_IDX                             = 836,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 296,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 882,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 718,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 788,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 278,
    SBK_QT_BGMODE_IDX                                        = 728,
    SBK_QT_KEY_IDX                                           = 802,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 804,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 286,
    SBK_QT_MODIFIER_IDX                                      = 812,
    SBK_QT_ARROWTYPE_IDX                                     = 722,
    SBK_QT_PENSTYLE_IDX                                      = 830,
    SBK_QT_PENCAPSTYLE_IDX                                   = 826,
    SBK_QT_PENJOINSTYLE_IDX                                  = 828,
    SBK_QT_BRUSHSTYLE_IDX                                    = 730,
    SBK_QT_SIZEMODE_IDX                                      = 846,
    SBK_QT_UIEFFECT_IDX                                      = 878,
    SBK_QT_CURSORSHAPE_IDX                                   = 750,
    SBK_QT_TEXTFORMAT_IDX                                    = 858,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 724,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 756,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 268,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 758,
    SBK_QT_TOOLBARAREA_IDX                                   = 868,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 302,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 870,
    SBK_QT_DATEFORMAT_IDX                                    = 752,
    SBK_QT_TIMESPEC_IDX                                      = 864,
    SBK_QT_DAYOFWEEK_IDX                                     = 754,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 838,
    SBK_QT_CASESENSITIVITY_IDX                               = 732,
    SBK_QT_CORNER_IDX                                        = 748,
    SBK_QT_EDGE_IDX                                          = 762,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 272,
    SBK_QT_CONNECTIONTYPE_IDX                                = 742,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 842,
    SBK_QT_FILLRULE_IDX                                      = 768,
    SBK_QT_MASKMODE_IDX                                      = 808,
    SBK_QT_CLIPOPERATION_IDX                                 = 738,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 798,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 800,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 876,
    SBK_QT_AXIS_IDX                                          = 726,
    SBK_QT_FOCUSREASON_IDX                                   = 774,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 744,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 792,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 282,
    SBK_QT_INPUTMETHODHINT_IDX                               = 790,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 280,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 764,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 872,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 806,
    SBK_QT_ANCHORPOINT_IDX                                   = 716,
    SBK_QT_FINDCHILDOPTION_IDX                               = 770,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 274,
    SBK_QT_DROPACTION_IDX                                    = 760,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 270,
    SBK_QT_CHECKSTATE_IDX                                    = 734,
    SBK_QT_ITEMDATAROLE_IDX                                  = 794,
    SBK_QT_ITEMFLAG_IDX                                      = 796,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 284,
    SBK_QT_MATCHFLAG_IDX                                     = 810,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 288,
    SBK_QT_WINDOWMODALITY_IDX                                = 886,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 860,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 300,
    SBK_QT_EVENTPRIORITY_IDX                                 = 766,
    SBK_QT_SIZEHINT_IDX                                      = 844,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 884,
    SBK_QT_COORDINATESYSTEM_IDX                              = 746,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 874,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 304,
    SBK_QT_GESTURESTATE_IDX                                  = 778,
    SBK_QT_GESTURETYPE_IDX                                   = 780,
    SBK_QT_GESTUREFLAG_IDX                                   = 776,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 276,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 820,
    SBK_QT_NAVIGATIONMODE_IDX                                = 822,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 912,
    SBK_QT_TIMERTYPE_IDX                                     = 866,
    SBK_QT_SCROLLPHASE_IDX                                   = 840,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 818,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 816,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 292,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 736,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 784,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 832,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 834,
    SBK_QTCOREQT_IDX                                         = 712,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 894,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 896,
    SBK_QTCOREHELPER_QIOPIPE_IDX                             = 898,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 900,
    SBK_QCBORKNOWNTAGS_IDX                                   = 72,
    SBK_QCBORSIMPLETYPE_IDX                                  = 78,
    SBK_QCBORTAG_IDX                                         = 92,
    SBK_QTMSGTYPE_IDX                                        = 902,
    SBK_QTCORE_IDX_COUNT                                     = 914,
};
...
enum : int {
    ...
    SBK_QLocale_TagSeparator_IDX                             = 193,
    ...
    SBK_QLocale_IDX                                          = 184,
    SBK_QLocationPermission_Accuracy_IDX                     = 195,
    SBK_QLocationPermission_Availability_IDX                 = 196,
    SBK_QLocationPermission_IDX                              = 194,
    SBK_QLockFile_LockError_IDX                              = 198,
    SBK_QLockFile_IDX                                        = 197,
    SBK_QLoggingCategory_IDX                                 = 199,
    SBK_QMargins_IDX                                         = 200,
    SBK_QMarginsF_IDX                                        = 201,
    SBK_QMessageAuthenticationCode_IDX                       = 202,
    SBK_QMessageLogContext_IDX                               = 203,
    SBK_QMetaClassInfo_IDX                                   = 204,
    SBK_QMetaEnum_IDX                                        = 205,
    SBK_QMetaMethod_Access_IDX                               = 207,
    SBK_QMetaMethod_MethodType_IDX                           = 208,
    SBK_QMetaMethod_IDX                                      = 206,
    SBK_QMetaObject_Call_IDX                                 = 210,
    SBK_QMetaObject_IDX                                      = 209,
    SBK_QMetaObject_Connection_IDX                           = 211,
    SBK_QMetaProperty_IDX                                    = 212,
    SBK_QMetaType_Type_IDX                                   = 214,
    SBK_QMetaType_TypeFlag_IDX                               = 215,
    SBK_QFlags_QMetaType_TypeFlag_IDX                        = 120,
    SBK_QMetaType_IDX                                        = 213,
    SBK_QMicrophonePermission_IDX                            = 216,
    SBK_QMimeData_IDX                                        = 217,
    SBK_QMimeDatabase_MatchMode_IDX                          = 219,
    SBK_QMimeDatabase_IDX                                    = 218,
    SBK_QMimeType_IDX                                        = 220,
    SBK_QModelIndex_IDX                                      = 221,
    SBK_QModelRoleData_IDX                                   = 222,
    SBK_QMutex_IDX                                           = 223,
    SBK_QNativeIpcKey_Type_IDX                               = 225,
    SBK_QNativeIpcKey_IDX                                    = 224,
    SBK_QObject_IDX                                          = 226,
    SBK_QOperatingSystemVersion_IDX                          = 227,
    ...
    SBK_QProcessEnvironment_Initialization_IDX               = 245,
    SBK_QProcessEnvironment_IDX                              = 244,
    SBK_QPropertyAnimation_IDX                               = 246,
    SBK_QRandomGenerator_IDX                                 = 247,
    SBK_QRandomGenerator64_IDX                               = 248,
    SBK_QReadLocker_IDX                                      = 249,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 251,
    SBK_QReadWriteLock_IDX                                   = 250,
    SBK_QRect_IDX                                            = 252,
    SBK_QRectF_IDX                                           = 253,
    SBK_QRecursiveMutex_IDX                                  = 254,
    SBK_QRegularExpression_PatternOption_IDX                 = 258,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 122,
    SBK_QRegularExpression_MatchType_IDX                     = 257,
    SBK_QRegularExpression_MatchOption_IDX                   = 256,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 121,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 259,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 123,
    SBK_QRegularExpression_IDX                               = 255,
    SBK_QRegularExpressionMatch_IDX                          = 260,
    SBK_QRegularExpressionMatchIterator_IDX                  = 261,
    SBK_QResource_Compression_IDX                            = 263,
    SBK_QResource_IDX                                        = 262,
    SBK_QRunnable_IDX                                        = 264,
    SBK_QSaveFile_IDX                                        = 265,
    SBK_QSemaphore_IDX                                       = 266,
    SBK_QSemaphoreReleaser_IDX                               = 267,
    SBK_QSequentialAnimationGroup_IDX                        = 268,
    SBK_QSettings_Status_IDX                                 = 272,
    SBK_QSettings_Format_IDX                                 = 270,
    SBK_QSettings_Scope_IDX                                  = 271,
    SBK_QSettings_IDX                                        = 269,
    SBK_QSharedMemory_AccessMode_IDX                         = 274,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 275,
    SBK_QSharedMemory_IDX                                    = 273,
    ...
    SBK_QWinEventNotifier_IDX                                = 343,
    SBK_QWriteLocker_IDX                                     = 344,
    SBK_QXmlStreamAttribute_IDX                              = 345,
    SBK_QXmlStreamAttributes_IDX                             = 346,
    SBK_QXmlStreamEntityDeclaration_IDX                      = 347,
    SBK_QXmlStreamEntityResolver_IDX                         = 348,
    SBK_QXmlStreamNamespaceDeclaration_IDX                   = 349,
    SBK_QXmlStreamNotationDeclaration_IDX                    = 350,
    SBK_QXmlStreamReader_TokenType_IDX                       = 354,
    SBK_QXmlStreamReader_ReadElementTextBehaviour_IDX        = 353,
    SBK_QXmlStreamReader_Error_IDX                           = 352,
    SBK_QXmlStreamReader_IDX                                 = 351,
    SBK_QXmlStreamWriter_IDX                                 = 355,
    SBK_Qt_GlobalColor_IDX                                   = 391,
    SBK_Qt_ColorScheme_IDX                                   = 370,
    SBK_Qt_MouseButton_IDX                                   = 407,
    SBK_QFlags_Qt_MouseButton_IDX                            = 145,
    SBK_Qt_Orientation_IDX                                   = 412,
    SBK_QFlags_Qt_Orientation_IDX                            = 147,
    SBK_Qt_FocusPolicy_IDX                                   = 386,
    SBK_Qt_TabFocusBehavior_IDX                              = 426,
    SBK_Qt_SortOrder_IDX                                     = 424,
    SBK_Qt_SplitBehaviorFlags_IDX                            = 425,
    SBK_QFlags_Qt_SplitBehaviorFlags_IDX                     = 149,
    SBK_Qt_TileRule_IDX                                      = 431,
    SBK_Qt_AlignmentFlag_IDX                                 = 357,
    SBK_QFlags_Qt_AlignmentFlag_IDX                          = 132,
    SBK_Qt_TextFlag_IDX                                      = 428,
    SBK_Qt_TextElideMode_IDX                                 = 427,
    SBK_Qt_WhiteSpaceMode_IDX                                = 440,
    SBK_Qt_HitTestAccuracy_IDX                               = 393,
    SBK_Qt_WindowType_IDX                                    = 445,
    SBK_QFlags_Qt_WindowType_IDX                             = 154,
    SBK_Qt_WindowState_IDX                                   = 444,
    SBK_QFlags_Qt_WindowState_IDX                            = 153,
    SBK_Qt_ApplicationState_IDX                              = 360,
    SBK_QFlags_Qt_ApplicationState_IDX                       = 133,
    SBK_Qt_ScreenOrientation_IDX                             = 418,
    SBK_QFlags_Qt_ScreenOrientation_IDX                      = 148,
    SBK_Qt_WidgetAttribute_IDX                               = 441,
    SBK_Qt_ApplicationAttribute_IDX                          = 359,
    SBK_Qt_ImageConversionFlag_IDX                           = 394,
    SBK_QFlags_Qt_ImageConversionFlag_IDX                    = 139,
    SBK_Qt_BGMode_IDX                                        = 364,
    SBK_Qt_Key_IDX                                           = 401,
    SBK_Qt_KeyboardModifier_IDX                              = 402,
    SBK_QFlags_Qt_KeyboardModifier_IDX                       = 143,
    SBK_Qt_Modifier_IDX                                      = 406,
    SBK_Qt_ArrowType_IDX                                     = 361,
    SBK_Qt_PenStyle_IDX                                      = 415,
    SBK_Qt_PenCapStyle_IDX                                   = 413,
    SBK_Qt_PenJoinStyle_IDX                                  = 414,
    SBK_Qt_BrushStyle_IDX                                    = 365,
    SBK_Qt_SizeMode_IDX                                      = 423,
    SBK_Qt_UIEffect_IDX                                      = 439,
    SBK_Qt_CursorShape_IDX                                   = 375,
    SBK_Qt_TextFormat_IDX                                    = 429,
    SBK_Qt_AspectRatioMode_IDX                               = 362,
    SBK_Qt_DockWidgetArea_IDX                                = 378,
    SBK_QFlags_Qt_DockWidgetArea_IDX                         = 134,
    SBK_Qt_DockWidgetAreaSizes_IDX                           = 379,
    SBK_Qt_ToolBarArea_IDX                                   = 434,
    SBK_QFlags_Qt_ToolBarArea_IDX                            = 151,
    SBK_Qt_ToolBarAreaSizes_IDX                              = 435,
    SBK_Qt_DateFormat_IDX                                    = 376,
    SBK_Qt_TimeSpec_IDX                                      = 432,
    SBK_Qt_DayOfWeek_IDX                                     = 377,
    SBK_Qt_ScrollBarPolicy_IDX                               = 419,
    SBK_Qt_CaseSensitivity_IDX                               = 366,
    SBK_Qt_Corner_IDX                                        = 374,
    SBK_Qt_Edge_IDX                                          = 381,
    SBK_QFlags_Qt_Edge_IDX                                   = 136,
    SBK_Qt_ConnectionType_IDX                                = 371,
    SBK_Qt_ShortcutContext_IDX                               = 421,
    SBK_Qt_FillRule_IDX                                      = 384,
    SBK_Qt_MaskMode_IDX                                      = 404,
    SBK_Qt_ClipOperation_IDX                                 = 369,
    SBK_Qt_ItemSelectionMode_IDX                             = 399,
    SBK_Qt_ItemSelectionOperation_IDX                        = 400,
    SBK_Qt_TransformationMode_IDX                            = 438,
    SBK_Qt_Axis_IDX                                          = 363,
    SBK_Qt_FocusReason_IDX                                   = 387,
    SBK_Qt_ContextMenuPolicy_IDX                             = 372,
    SBK_Qt_InputMethodQuery_IDX                              = 396,
    SBK_QFlags_Qt_InputMethodQuery_IDX                       = 141,
    SBK_Qt_InputMethodHint_IDX                               = 395,
    SBK_QFlags_Qt_InputMethodHint_IDX                        = 140,
    SBK_Qt_EnterKeyType_IDX                                  = 382,
    SBK_Qt_ToolButtonStyle_IDX                               = 436,
    SBK_Qt_LayoutDirection_IDX                               = 403,
    SBK_Qt_AnchorPoint_IDX                                   = 358,
    SBK_Qt_FindChildOption_IDX                               = 385,
    SBK_QFlags_Qt_FindChildOption_IDX                        = 137,
    SBK_Qt_DropAction_IDX                                    = 380,
    SBK_QFlags_Qt_DropAction_IDX                             = 135,
    SBK_Qt_CheckState_IDX                                    = 367,
    SBK_Qt_ItemDataRole_IDX                                  = 397,
    SBK_Qt_ItemFlag_IDX                                      = 398,
    SBK_QFlags_Qt_ItemFlag_IDX                               = 142,
    SBK_Qt_MatchFlag_IDX                                     = 405,
    SBK_QFlags_Qt_MatchFlag_IDX                              = 144,
    SBK_Qt_WindowModality_IDX                                = 443,
    SBK_Qt_TextInteractionFlag_IDX                           = 430,
    SBK_QFlags_Qt_TextInteractionFlag_IDX                    = 150,
    SBK_Qt_EventPriority_IDX                                 = 383,
    SBK_Qt_SizeHint_IDX                                      = 422,
    SBK_Qt_WindowFrameSection_IDX                            = 442,
    SBK_Qt_CoordinateSystem_IDX                              = 373,
    SBK_Qt_TouchPointState_IDX                               = 437,
    SBK_QFlags_Qt_TouchPointState_IDX                        = 152,
    SBK_Qt_GestureState_IDX                                  = 389,
    SBK_Qt_GestureType_IDX                                   = 390,
    SBK_Qt_GestureFlag_IDX                                   = 388,
    SBK_QFlags_Qt_GestureFlag_IDX                            = 138,
    SBK_Qt_NativeGestureType_IDX                             = 410,
    SBK_Qt_NavigationMode_IDX                                = 411,
    SBK_Qt_CursorMoveStyle_IDX                               = 456,
    SBK_Qt_TimerType_IDX                                     = 433,
    SBK_Qt_ScrollPhase_IDX                                   = 420,
    SBK_Qt_MouseEventSource_IDX                              = 409,
    SBK_Qt_MouseEventFlag_IDX                                = 408,
    SBK_QFlags_Qt_MouseEventFlag_IDX                         = 146,
    SBK_Qt_ChecksumType_IDX                                  = 368,
    SBK_Qt_HighDpiScaleFactorRoundingPolicy_IDX              = 392,
    SBK_Qt_PermissionStatus_IDX                              = 416,
    SBK_Qt_ReturnByValueConstant_IDX                         = 417,
    SBK_QtCoreQt_IDX                                         = 356,
    SBK_QtCoreHelper_QGenericArgumentHolder_IDX              = 447,
    SBK_QtCoreHelper_QGenericReturnArgumentHolder_IDX        = 448,
    SBK_QtCoreHelper_QIOPipe_IDX                             = 449,
